...
if ($_POST) {
    ...
    //convertir el array tareas en Json
                ...
                <form action="" method="POST">
                    <div class="row py-3">
                        <div class="col-4">
                            ...
                            <select name="lstPrioridad" id="lstPrioridad" class="form-control" required>
                                ...
                                <option value="Baja" <?php echo isset($aTareas[$id]) && $aTareas[$id]["prioridad"] == "Baja"? "selected": ""; ?>>Baja</option>>Baja</option>
                            </select>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <select name="lstUsuario" id="lstUsuario" class="form-control" required>
                                <option value="" disabled selected>Seleccionar</option>
                                <option value="Ana" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Ana"? "selected": ""; ?>>Ana</option>>Ana</option>
                                <option value="Bernabe" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Bernabe"? "selected": ""; ?>>Bernabe</option>>Bernabe</option>
                                <option value="Daniela" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Daniela"? "selected": ""; ?>>Daniela</option>>Daniela</option>
                            </select>
                        </div>
                    ...
                    <div class="row pb-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="txtTitulo" id="txtTitulo" class="form-control" required value="<?php isset($aTareas[$id])? $aTareas[$id]["titulo"] : ""; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea name="txtDescripcion" id="txtDescripcion" required class="form-control" value="<?php isset($aTareas[$id])? $aTareas[$id]["descripcion"]: ""; ?>"></textarea>
                        </div>
                    </div>
